...
const Thumbnail = () => {
  ...
  return (
    <div>
      ...
      >
        {translateUi('ui.sections.content.upload.common.thumbnail_20f9b91f')}
      </Typography>
      <FileDropZone
      ...
      >
        ...
        >
          {translateUi(
            'ui.sections.content.upload.common.images_should_be_in_jpeg_or_png_format_up_to_15mb_in_ec30bde4',
          )}
        </Typography>
      </Stack>
    </div>
