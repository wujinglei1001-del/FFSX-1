...
export const menuItems = [
  {
    ...
    get text() {
      return i18n.t('ui.sections.crm.deals.list_container.rename_section_45e65cd4');
    },
  },
  {
    icon: 'material-symbols:content-copy-outline-rounded',
    get text() {
      return i18n.t('ui.sections.crm.deals.list_container.copy_list_105c19e2');
    },
  },
  {
    icon: 'material-symbols:delete-outline-rounded',
    get text() {
      return i18n.t('ui.sections.crm.deals.list_container.delete_this_list_0a2fe7ad');
    },
  },
];
