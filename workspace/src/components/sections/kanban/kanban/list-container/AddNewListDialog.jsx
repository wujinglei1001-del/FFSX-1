  ...
  return (
    ...
    >
      <DialogTitle id="dialog-title" sx={{ p: 0, mb: 1, typography: 'h6' }}>
        {translateUi('ui.sections.kanban.kanban.list_container.add_new_list_c375c023')}
      </DialogTitle>
      <DialogContent sx={{ p: 0, mb: 3, overflow: 'visible' }}>
        ...
        >
          {translateUi(
            'ui.sections.kanban.kanban.list_container.create_a_new_list_to_organize_your_tasks_ea0ad3ba',
          )}
        </DialogContentText>
        ...
        <Stack direction={{ xs: 'column', sm: 'row' }} sx={{ gap: 2 }}>
          <TextField
            id="filled-basic"
            label={translateUi('ui.sections.kanban.kanban.list_container.list_name_bb5453db')}
            variant="filled"
            name="title"
            value={newList.title}
          ...
          <FormControl sx={{ minWidth: 128 }}>
            <InputLabel id="select-filled-label">
              {translateUi('ui.sections.kanban.kanban.list_container.column_no_1f9c1abd')}
            </InputLabel>
            <Select
              label={translateUi('ui.sections.kanban.kanban.list_container.column_no_1f9c1abd')}
      ...
      <DialogActions sx={{ p: 0 }}>
        <Button variant="soft" color="neutral" onClick={handleDiscardChanges}>
          {translateUi('ui.sections.kanban.kanban.list_container.discard_36fff63c')}
        </Button>
        <Button type="submit" variant="contained" autoFocus>
          {translateUi('ui.sections.kanban.kanban.list_container.confirm_04a21221')}
        </Button>
      </DialogActions>
      <Button
        shape="square"
