...
import PickersFilledInput from './components/pickers/date/PickersFilledInput';
import PickersLayout from './components/pickers/date/PickersLayout';
import PickersOutlinedInput from './components/pickers/date/PickersOutlinedInput';
import PickersTextField from './components/pickers/date/PickersTextField';
  ...
  const theme = muiCreateTheme(
    {
      ...
      components: {
        ...
        MuiPickersFilledInput: PickersFilledInput,
